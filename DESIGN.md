# dictionaryofpatterns design

## Table of Contents

- [dictionaryofpatterns design](#dictionaryofpatterns-design)
...
`dictionaryofpatterns` is designed to be a searchable dictionary of software development patterns which comes with a set of visuals & code components to help with implementation & validation of the standard patterns.

## How is it different from what I already use?

**WORK IN PROGRESS**: `dictionaryofpatterns` is still in the `design` phase.
...
`dictionaryofpatterns` is a part of the [Open Source Universe](https://github.com/intellibus/approach). All Projects in the [Open Source Universe](https://github.com/intellibus/approach) follow the same [Contribution Guidelines & Process](https://github.com/intellibus/approach).
...
`dictionaryofpatterns` only plans to initially support Typescript & JavaScript Applications. However, we would love for the community to contribute versions for other languages (Java, Go, etc.)
